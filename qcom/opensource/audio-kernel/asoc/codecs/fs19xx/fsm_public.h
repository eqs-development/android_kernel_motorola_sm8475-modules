...
#define fsm_codec_name(idx)     fsm_get_config()->codec_name[idx]
#define fsm_codec_dai_name(idx) fsm_get_config()->codec_dai_name[idx]
#define fsm_get_dev_count()     fsm_get_config()->dev_count
